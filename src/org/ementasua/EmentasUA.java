...
public class EmentasUA extends TabActivity {
	...
	protected void onResume(){
		...
		if(ep == null){
			...
			if(ep == null || (ep.getEmentaCantina().date.getDate() != cal.get(Calendar.DATE)
					   || ep.getEmentaCantina().date.getMonth() != cal.get(Calendar.MONTH)
					   || (ep.getEmentaCantina().date.getYear()+1900) != cal.get(Calendar.YEAR)) ){ 
